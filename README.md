...
Evidence-first track identification for DJ sets. Stage 2a adds support-time benchmark scoring, a
deterministic controlled-transform corpus, and independent truth annotation to the Stage 1 ingest,
decode, windowing, durable Shazam jobs, measured anchors, caching, and raw observations.
